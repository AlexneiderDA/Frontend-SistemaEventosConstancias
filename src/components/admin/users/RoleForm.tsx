...
export const RoleForm: React.FC<RoleFormProps> = ({ isOpen, onClose, role, onSubmit }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{role?.id ? "Editar Rol" : "Crear Nuevo Rol"}</DialogTitle>
          <DialogDescription>
            {role?.id ? "Modifica la información del rol existente." : "Define un nuevo rol para el sistema."}
          </DialogDescription>
        </DialogHeader>
